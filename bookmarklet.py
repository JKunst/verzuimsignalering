...
_TAIL_DOWNLOAD = (
 ...
 "alert('Bestand gedownload ('+students.length+' leerlingen). Upload het in de app Verzuimsignalering.');"
)
...
_TAIL_POST = (
 ...
 "alert('Verzuim verstuurd ('+students.length+' leerlingen). Ga terug naar het tabblad van Verzuimsignalering.');"
)
